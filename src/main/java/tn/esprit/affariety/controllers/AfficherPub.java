...
public class AfficherPub {
    ...
    void modifierPub(ActionEvent event) {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/affariety/modifierPub.fxml"));
            try {
    ...
    public void afficherCommentaire(ActionEvent actionEvent) {
        ...
        if (selectedPublication != null) {
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/affariety/GestionCom.fxml"));
                Parent root = loader.load();
    ...
    public void StatistiqueBtn(ActionEvent actionEvent) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/affariety/Statistique.fxml"));
            Parent root = loader.load();
    ...
    public void AjouterPub(ActionEvent actionEvent) {
        try {
            // Charger le fichier FXML
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/affariety/UserAffichePub.fxml"));
            Parent root = loader.load();
