...
//                }
                ...
                private void openMap(float latitude, float longitude) throws IOException {
                    ...
                    FXMLLoader fxmlLoader = new FXMLLoader((HelloApplication.class.getResource("/tn/esprit/affariety/LocationView.fxml")));
    ...
    void back(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tn/esprit/affariety/Ajouterlivraison.fxml"));
    ...
    void ondepot(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tn/esprit/affariety/Ajouterdepot.fxml"));
            Parent root = fxmlLoader.load();
            AnchorPaneaff.getChildren().setAll(root);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    void VersModifier(ActionEvent event) {
        ...
        if (selectedLivraison != null) {
            Editlivraison.adresselivraison_static = selectedLivraison.getAdresselivraison();
            Editlivraison.datecommande_static = selectedLivraison.getDatecommande();
            Editlivraison.datelivraison_static = selectedLivraison.getDatelivraison();
            Editlivraison.statuslivraison_static = selectedLivraison.getStatuslivraison();
            Editlivraison.iddepot_static = selectedLivraison.getIddepot();
            Editlivraison.latitude = selectedLivraison.getLatitude();
            Editlivraison.longitude = selectedLivraison.getLongitude();
            Editlivraison.id = selectedLivraison.getId();
            try {

                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tn/esprit/affariety/Editlivraison.fxml"));
                Parent root = fxmlLoader.load();
    ...
    void toStat(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tn/esprit/affariety/statistique.fxml"));
            Parent root = fxmlLoader.load();
            AnchorPaneaff.getChildren().setAll(root);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    void ToMailing(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tn/esprit/affariety/mailing.fxml"));
            Parent root = fxmlLoader.load();
            AnchorPaneaff.getChildren().setAll(root);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void gotolivraison(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/affariety/Ajouterlivraison.fxml"));
    ...
    void retour(ActionEvent event) {
        try {
            Parent root = load(getClass().getResource("/tn/esprit/affariety/Ajouterlivraison.fxml"));
            AnchorPaneaff = null;
